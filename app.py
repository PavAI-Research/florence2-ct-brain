...
## hard code to cpu for quick test
device = "cpu"

model_id_or_path = "mychen76/Florence2-FT-Med-brain-7"

with patch("transformers.dynamic_module_utils.get_imports", fixed_get_imports): #workaround for unnecessary flash_attn requirement
    #model = AutoModelForCausalLM.from_pretrained(model_id_or_path, attn_implementation="sdpa", trust_remote_code=True)
...
task_mapping = {
    ...
    "Detect Region Location": "DETECT_REGION_LOC",
    "Caption": "CAPTION",
    "Detailed Caption": "CAPTION_DETAILS",
    "Region Location Description": "REGION_LOC_DESCRIPTION",
...
with gr.Blocks() as demo:
    gr.Markdown("# 🪟 Microsoft Florence-2 Vision Model for Brain CT-Image")
    ...
    with gr.Row():
        with gr.Column():
            ...
            text_input = gr.Textbox(label="Text Input (Optional)", lines=1, placeholder="Enter text", visible=False)
